const experiences = [
  ...
  },
  {
    ...
    description: [
      "Optimized Jenkins deployment workflows, reducing errors and effort by 40%.",
      "Automated tasks using Python and Bash, improving efficiency by 30%.",
      "Implemented SonarQube and DevOps practices, cutting code defects by 25%.",
      "Built automated test frameworks, reducing manual testing by 50%.",
      "Managed Git version control and automated builds with Maven and Gradle."
    ]
  },
  {
	...
	image: '/png/wipro.jpeg',
    description: [
      "Enhanced deployments with Jenkins and Docker, improving efficiency by 30%.",
      "Automated tasks using Python and Linux scripting, saving manual work by 25%.",
      "Collaborated with senior engineers to troubleshoot and resolve issues quickly."
    ]
  }
];
